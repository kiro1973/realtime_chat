...
async function deleteMessage(messageId,userId, socket) {
    try {
      ...
      // Find the chat containing the deleted message
      ...
      // Remove the deleted message from the chat's messages array
      chat.messages.pull(messageId);
      await chat.save();
  
      // Optionally, you can perform additional operations or emit events here
